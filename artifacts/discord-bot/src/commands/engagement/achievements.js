...
export default {
  ...
  async execute(message, args, client) {
    ...
    const lockedIds = Object.keys(ACHIEVEMENTS).filter(
      id => !unlocked.find(a => a.id === id)
    );
